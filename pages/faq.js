...
export default function FAQ() {
    return (
        <>
            <Head>
                <title>El Mesquitito Grill | FAQ | Authentic Mexican Restaurant</title>
                ...
                <div className="accordion" id="accordionExample">
                    ...
                    <div className="accordion-item">
                        ...
                        <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                            <div className="accordion-body">
                                Lorem ipsum dolor sit amet consectetiveadipisicing elit. Vel, aut. Animi culpa sequi nisi, ad, recusandae minus commodi accusamus debitis libero quidem ipsam qui architecto quo nihil doloribus quos asperiores.
                            </div>
                        </div>
                    </div>
                    <div className="accordion-item">
